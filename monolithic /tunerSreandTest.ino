...
if (frequency < 213.825) {   //A 4 220 213.825 226.54  
  fill_solid( &(leds[i]), 150 /*number of leds*/, CRGB(250,2,60) );
  FastLED.show();
  delay(100);
  ...
  fill_solid( &(leds[i]), 150 /*number of leds*/, CRGB( 85,98,112) );
  FastLED.show();
  delay(100);
   // Now turn the LED off, then pause
   // leds[0] = CRGB::Black;
...
fill_solid( &(leds[i]), 150 /*number of leds*/, CRGB(78,205,196) );
  FastLED.show();
  delay(100);
   // Now turn the LED off, then pause
   // leds[0] = CRGB::Black;
  ...
  fill_solid( &(leds[i]), 150 /*number of leds*/, CRGB( 199,244,100) );
  FastLED.show();
  delay(100);
   // Now turn the LED off, then pause
   // leds[0] = CRGB::Black;
  ...
  fill_solid( &(leds[i]), 150 /*number of leds*/, CRGB( 255,107,107) );
  FastLED.show();
  ...
  fill_solid( &(leds[i]), 150 /*number of leds*/, CRGB( 196,77,88) );
  FastLED.show();
delay(100);
   // Now turn the LED off, then pause
   // leds[0] = CRGB::Black;
  ...
  fill_solid( &(leds[i]), 150 /*number of leds*/, CRGB( 240,65,85) );
  FastLED.show();
  delay(100);
   // Now turn the LED off, then pause
   // leds[0] = CRGB::Black;
  ...
  fill_solid( &(leds[i]), 150 /*number of leds*/, CRGB( 255,130,58) );
  FastLED.show();
delay(100);
   // Now turn the LED off, then pause
   // leds[0] = CRGB::Black;
  ...
  fill_solid( &(leds[i]), 150 /*number of leds*/, CRGB( 242,242,111) );
  FastLED.show();
  delay(100);
   // Now turn the LED off, then pause
   // leds[0] = CRGB::Black;
  ...
  fill_solid( &(leds[i]), 150 /*number of leds*/, CRGB( 255,247,189) );
  FastLED.show();
  delay(100);
   // Now turn the LED off, then pause
   // leds[0] = CRGB::Black;
  ...
  fill_solid( &(leds[i]), 150 /*number of leds*/, CRGB( 149,207,183) );
  FastLED.show();
  delay(100);
   // Now turn the LED off, then pause
   // leds[0] = CRGB::Black;
  ...
  fill_solid( &(leds[i]), 150 /*number of leds*/, CRGB( 81,81,81) );
  FastLED.show();
  delay(100);
   // Now turn the LED off, then pause
   // leds[0] = CRGB::Black;
  ...
  fill_solid( &(leds[i]), 150 /*number of leds*/, CRGB( 255,255,255) );
  FastLED.show();
  delay(100);
   // Now turn the LED off, then pause
   // leds[0] = CRGB::Black;
...
fill_solid( &(leds[i]), 150 /*number of leds*/, CRGB( 0,180,255) );
FastLED.show();
  delay(100);
   // Now turn the LED off, then pause
   // leds[0] = CRGB::Black;
  ...
  fill_solid( &(leds[i]), 150 /*number of leds*/, CRGB( 118,73,172) );
  FastLED.show();
  delay(100);
   // Now turn the LED off, then pause
   // leds[0] = CRGB::Black;
  ...
  fill_solid( &(leds[i]), 150 /*number of leds*/, CRGB( 176,222,234) );
  FastLED.show();
  delay(100);
   // Now turn the LED off, then pause
   // leds[0] = CRGB::Black;
...
else { fill_solid( &(leds[i]), 150 /*number of leds*/, CRGB( 149,207,183) ); // EXIT THE LOOP
FastLED.show();
 delay(100);
}
}
